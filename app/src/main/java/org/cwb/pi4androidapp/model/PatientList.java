...
import org.cwb.pi4androidapp.ws.VolleySingleton;
...
public class PatientList {
     ...
     */
    public void GetPatientsList(final RefreshHandler handler) {
            ...
            public void onResponse(JSONArray response) {
                try {
                    ...
                    for (int i = 0; i < response.length(); i++) {
                        ...
                        p.setPatientId(o.getInt("patientId"));
                        p.setPatientName(o.getString("patientName"));
                        p.setPregnancyWeek(Double.valueOf(o.getString("pregnancyWeek")));
                        patientList.add(p);
                    }
